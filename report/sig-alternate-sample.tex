...
%       \affaddr{Karlsplatz 13}\\
%       \affaddr{1040, Vienna}\\
%       \email{e1025658@student.tuwien.ac.at}
%% 3rd. author
%\alignauthor
%Marten Sigwart \\
%       \affaddr{Technical University of Vienna}\\
...
3 & 95.635 & 4.365 \\
\end{tabular}
\captionof{table}{Results with default settings}
\end{center}
...
8 & 95.75 & 4.25 \\
\end{tabular}
\captionof{table}{Results with weighting 1/d}
\end{center}
...
100 &  84.3 & 15.7 \\
\end{tabular}
\captionof{table}{Results for high K's}
\end{center}
...
10 & 86.76\% \\
\end{tabular}
\captionof{table}{Adjusting the maximum number of parents of a node}
\end{center}
...
\end{tabular}
\captionof{table}{General results for different no. of neighbors}
\end{center}
...
100 & 0.161 & 0.999\\
\end{tabular}
\captionof{table}{True positive rates for different no. of neighbors}
\end{center}
...
\end{tabular}
\captionof{table}{General performance with or without distance weighting}
\end{center}
...
\end{tabular}
\captionof{table}{True positive rates with or without distance weighting}
\end{center}
...
\end{tabular}
\captionof{table}{General performance for different number of trees}
\end{center}
...
\end{tabular}
\captionof{table}{General performance for default implementation}
\end{center}
...
\end{tabular}
\captionof{table}{General performance for minNumObj}
\end{center}
...
97.1\% & 0.970 & 0.942\\
\end{tabular}
\captionof{table}{General performance with an unpruned tree}
\end{center}
...
\end{tabular}
\captionof{table}{General performance with Bayes Network}
\end{center}
...
\end{tabular}
\captionof{table}{Results with different number of trees and features}
\end{center}
...
Hill Climber& 1 & 98\% \\
\end{tabular}
\captionof{table}{BayesNet results}
\end{center}
...
\end{tabular}
\captionof{table}{Results fpr different numbers of attributes }
\end{center} 
...
\end{tabular}
\captionof{table}{Results for different tree depths}
\end{center}
...
\end{tabular}
\captionof{table}{Results for pruning with different confidence factors}
\end{center} 
...
\end{tabular}
\captionof{table}{Results with different search algorithms}
\end{center}
