...
\begin{center}
\begin{tabular}{ c | c | c | c | c | c}
\textbf{\# of Trees} & \textbf{\% Correctly Classified} & \textbf{TP Rate Ad} & \textbf{TP Rate Non-Ad} & \textbf{F-Measure} & \textbf{ROC Area}\\
2   & 93.69\% & 0.743 & 0.968  & 0.936 & 0.885\\
3   & 94.75\% & 0.695 & 0.989 & 0.945 & 0.914\\
4   & 94.88\% & 0.717 & 0.987 & 0.946 & 0.93\\
5   & 95.09\% & 0.695 & 0.993 & 0.948 & 0.944\\
6   & 95.09\% & 0.688 & 0.994 & 0.948 & 0.956\\
8   & 95.12\% & 0.688 & 0.994 & 0.948 & 0.962\\
10  & 95.46\% & 0.697 & 0.996 & 0.951 & 0.968\\
20  & 95.67\% & 0.706 & 0.998 & 0.954 & 0.977\\
50  & 95.7 \% & 0.704 & 0.998 & 0.954 & 0.982\\
100 & 95.52\% & 0.691 & 0.998 & 0.952 & 0.984\\
200 & 95.6 \% & 0.697 & 0.998 & 0.953 & 0.985\\
\end{tabular}
\end{center}
...
\begin{center}
\begin{tabular}{ c | c | c | c | c | c}
\textbf{Min. \# Obj} & \textbf{\% Correctly Classified} & \textbf{TP Rate Ad} & \textbf{TP Rate Non-Ad} & \textbf{F-Measure} & \textbf{ROC Area}\\
2  & 96.89\% & 0.83  & 0.991 & 0.968 & 0.919\\
5  & 96.58\% & 0.817 & 0.99  & 0.965 & 0.924\\
10 & 96.65\% & 0.826 & 0.989 & 0.966 & 0.923\\
20 & 95.73\% & 0.773 & 0.987 & 0.956 & 0.885\\
\end{tabular}
\end{center}
...
\begin{tabular}{c | c | c | c | c}
\textbf{\% Correctly Classified} & \textbf{TP Rate Ad} & \textbf{TP Rate Non-Ad} & \textbf{F-Measure} & \textbf{ROC Area}\\
97.1\% & 0.85 & 0.991  & 0.970 & 0.942\\
\end{tabular}
\end{center}

We can see that not pruning the tree seems to imporve the results of the classifier. This is the highest percentage of correctly classified instances we received so far for this data set.
...
\begin{center}
\begin{tabular}{ c | c | c | c | c | c}
\textbf{Estimater} & \textbf{\% Correctly Classified} & \textbf{TP Rate Ad} & \textbf{TP Rate Non-Ad} & \textbf{F-Measure} & \textbf{ROC Area}\\
Simple   & 96.58\% & 0.778 & 0.996  & 0.964 & 0.967\\
BayesNet & 96.52\% & 0.773 & 0.996 & 0.964 & 0.967\\
\end{tabular}
\end{center}
